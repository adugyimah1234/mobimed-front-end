...
function Aboutsection() {
  return (
    <div className="flex flex-col justify-between items-around gap-[60px] m-40 mx-0 py-20 px-50">
      {/* Header section */}
      ...
      <div className="flex flex-row justify-center items-center">
        <div className="flex flex-col justify-center items-center m-20 gap-[153px]">
          {/* Feature 1 */}
          <div className="flex flex-row justify-start items-center gap-6 w-auto box-border">
